...
import { saveInstitutionData, clearAllAuthData } from "./auth/authHelpers";
...
function InstitutionLoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const verificationResult = await ensureEmailVerifiedForLogin({
        user,
        role: "institution",
        displayName: userData.displayName || userData.orgNameAr || userData.orgNameEn || user.email,
        language,
      });
      ...
      try {
        ...
        console.warn("Profile load warning:", e2);
      }

      const savedData = saveInstitutionData(completeUserData);
      updateUserData(savedData);

      alert(language === "en" ? "Welcome back! Login successful." : "اهلا بعودتك! تم تسجيل الدخول بنجاح.");
      ...
      switch (authError.code) {
        ...
        case "auth/user-not-found":
          errorMessage = language === "en" ? "No institution found with this email." : "لا توجد مؤسسة بهذا البريد الإلكتروني.";
          break;
        ...
        case "auth/too-many-requests":
          ...
          break;
        default:
          errorMessage = language === "en" ? "Login failed. Please check your credentials and try again." : "فشل تسجيل الدخول. يرجى التحقق من بيانات الاعتماد والمحاولة مرة أخرى.";
      }
  ...
  const headerTexts = {
    en: {
      badge: "ORGANIZATION LOGIN",
      title: "Welcome Back to Your Organization",
      subtitle: "Access your organization dashboard and manage volunteers",
      welcome: "Welcome Back, Organization",
      description: "Sign in to manage your organization's volunteering activities.",
    ...
    ar: {
      badge: "تسجيل دخول المؤسسة",
      title: "مرحباً بعودتك إلى مؤسستك",
      subtitle: "ادخل إلى لوحة تحكم مؤسستك وادِر المتطوعين",
      welcome: "مرحباً بعودتك، المؤسسة",
      description: "سجّل الدخول لإدارة أنشطة التطوع الخاصة بمؤسستك.",
  ...
  return (
    <div className={`login-page organization-login ${language === "ar" ? "rtl" : ""}`}>
      
      <div className="login-header-image">
        <img 
          src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=2000&q=90&auto=format&fit=crop" 
          alt="Organization"
        />
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input 
              ...
              required 
              disabled={loading}
              placeholder={language === "en" ? "organization@example.com" : "مؤسسة@مثال.com"}
              style={{
                width: '100%',
                padding: '12px',
          ...
          <div style={{ textAlign: language === "ar" ? "left" : "right", margin: "8px 0 18px" }}>
            <Link to="/reset-password?role=institution" style={{ color: "#9b5f2d", fontWeight: "600", fontSize: "14px" }}>
          ...
          <div className="login-switch-panel">
            <p className="new-account login-switch-primary">
              {t.noAccount}{" "}
              <Link to="/institution-register" className="login-register-link">
                {t.createAccount}
              </Link>
            </p>
